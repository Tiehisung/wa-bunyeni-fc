...
export interface ITransaction {
    ...
    amount: number
    category: EIncomeCategory | EExpenseCategory
    description: string
    date: string
    notes?: string
...
export interface ITransactionsSummary {
    ...
    netBalance: number
    incomeByCategory: Record<EIncomeCategory | EExpenseCategory, number>
    expensesByCategory: Record<EIncomeCategory | EExpenseCategory, number>
    period: {
        startDate: string
        endDate: string
    }
